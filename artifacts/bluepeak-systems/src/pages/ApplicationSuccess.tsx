...
export function ApplicationSuccess() {
  ...
  return (
    <SiteLayout
      title="Application Received — BluePeak Systems"
      description="Thank you for applying to BluePeak Systems. Your application has been received."
    >
        ...
        <div className="success-card reveal is-visible">
          ...
          <div className="success-contact-box">
            ...
            <div>
              ...
              <a href="mailto:careers@bluepeaksystems.top" className="success-email">
                careers@bluepeaksystems.top <ArrowUpRight size={14} />
              </a>
            </div>
          </div>
