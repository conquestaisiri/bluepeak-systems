        ...
        <div className="auth-card reveal is-visible">
          ...
          {state === 'success' ? (
            <div className="auth-success">
              ...
              <p>{message}</p>
              <p className="auth-hint">The link expires in 15 minutes. If you don&apos;t see it, check your spam folder.</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="auth-form" noValidate>
              ...
              <button type="submit" className="button button-blue auth-submit" disabled={state === 'submitting'}>
                {state === 'submitting' ? (
                  <>
              ...
              <p className="auth-note">
                By continuing, you agree to our <a href="/#contact">Terms of Service</a> and <a href="/#contact">Privacy Policy</a>.
                We&apos;ll only use your email to send the sign-in link and application updates.
              </p>
            </form>
          )}
