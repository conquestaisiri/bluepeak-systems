        ...
        <div className="container careers-cta-inner">
          <div>
            ...
            <p className="careers-cta-sub">
              ...
              <a href="mailto:careers@bluepeaksystems.top" className="cta-email">careers@bluepeaksystems.top</a>{' '}
              and we will keep you in mind for future opportunities.
            </p>
          </div>
          <a href="mailto:careers@bluepeaksystems.top" className="button button-mint">
